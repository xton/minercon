...
## 11. Publishing & audience roadmap

See **[PUBLISHING.md](PUBLISHING.md)** for the full checklist (pre-flight,
npm, VS Code Marketplace, addon registries, announce channels, and original
author courtesy).
